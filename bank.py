...
class Bank():
    ...
    def __init__(self):
        ...
        for acc in row:
            if acc[3] == "SavingsAccount":
                 self.create_account(acc[3], acc[1], acc[2], acc[4], save=False, account_id=acc[0])
            elif acc[3] == "CheckingAccount":
                self.create_account(acc[3], acc[1], acc[2], acc[5], save=False, account_id=acc[0])
            

    def create_account(self, account_type, owner, balance, extra_param, save=True, account_id=None):
        """
    ...
    def get_account(self, account_id):
        ...
        try:
            ...
            raise ValueError("Invalid account number — please copy and paste your account ID")
    ...
    def transfer_account(self, from_id, to_id, amount):
        ...
        except (KeyError, InsufficientFundsError):
            raise
        ...
        try:
            ...
            raise KeyError("Transfer incomplete")
    ...
    def bank_deposit(self, account_id, amount):
        ...
        self._data_base.update(account_id, account._balance)
